              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                {messages.length === 0 ? (
                  ...
                  <div className="h-full flex flex-col justify-center items-center text-center space-y-6 max-w-md mx-auto">
                    <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 rounded-2xl text-indigo-400 animate-pulse-slow">
                    ...
                    <div className="w-full space-y-2.5 pt-4">
                      ...
                      <button
                        ...
                        className="w-full text-left p-3.5 bg-zinc-950 hover:bg-zinc-900 border border-zinc-900 hover:border-indigo-500/30 hover:pl-5 text-xs rounded-xl text-zinc-300 hover:text-white transition-all duration-300 flex items-center gap-2 border-l-2 border-l-indigo-500 cursor-pointer"
                      >
